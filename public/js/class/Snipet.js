...
Snipet.prototype.init = function(){
	...
	var popup = "<div class='popup'><p>copy this snipet code for use this wireframe on your website <span class='close'>X</span> </p><button class='showSnip btn btn-default'>show snipet</button><button disabled class='btn btn-default'>copy</button></div>"
	$elem.append(popup);
	var $popup = $('.popup');
	var result = null;
	var opened = false;
